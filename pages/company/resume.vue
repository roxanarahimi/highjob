<template>
  ...
  <div class="row mt-4 ">
    <div class="d-flex  mb-3">
      ...
      <button class="btn  btn-sm btn-primary me-2 mb-2">دیده شد</button>
      <button class="btn btn-sm btn-outline-primary me-2 mb-2">تایید اولیه</button>
      <button class="btn btn-sm btn-outline-primary me-2 mb-2">تایین وقت مصاحبه</button>
      <button class="btn btn-sm btn-outline-primary me-2 mb-2">استخدام شد</button>
      <button class="btn btn-sm btn-outline-primary me-2 mb-2">رد شد</button>
