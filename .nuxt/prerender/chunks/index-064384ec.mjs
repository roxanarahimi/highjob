...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><div class="row flex-row-reverse"><div class="col-lg-6 txt"><h1 style="${ssrRenderStyle({ "font-size": "100px", "text-align": "left !important" })}">\u0634\u063A\u0644</h1><h3 style="${ssrRenderStyle({ "font-size": "60px", "text-align": "left !important" })}">\u0631\u0648\u06CC\u0627\u0647\u0627\u062A\u0648 </h3><h5 style="${ssrRenderStyle({ "font-size": "35px", "text-align": "left !important" })}">\u0627\u06CC\u0646\u062C\u0627 \u067E\u06CC\u062F\u0627 \u06A9\u0646 </h5></div><div class="col-lg-6"><img class="ss"${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "max-width": "400px" })}" alt=""></div></div><div class="row"><div class="col-12 mx-auto"><div class="card border-0 shadow"><div class="card-body pb-md-5"><div class="form"><form action=""><h5 class="d-inline-block pb-2 mb-3">\u062C\u0633\u062A\u062C\u0648 \u06A9\u0646\u06CC\u062F</h5><div class="row"><div class="col-12 col-sm-10"><div class="row"><div class="col-sm-4 mb-2"><input type="text" placeholder="\u0639\u0646\u0648\u0627\u0646 \u0634\u063A\u0644\u06CC" class="form-control form-control-sm"></div><div class="col-sm-4 mb-2"><input type="text" placeholder="\u06AF\u0631\u0648\u0647 \u0634\u063A\u0644\u06CC" class="form-control form-control-sm"></div><div class="col-sm-4 mb-2"><input type="text" placeholder="\u0634\u0647\u0631" class="form-control form-control-sm"></div></div></div><div class="col-12 col-sm-2"><button class="btn btn-sm btn-block btn-primary w-100">\u0628\u0631\u0648</button></div></div></form></div></div></div></div></div></div>`);
}
...
//# sourceMappingURL=index-064384ec.mjs.map
