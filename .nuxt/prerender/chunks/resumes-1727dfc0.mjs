...
import { _ as _imports_0 } from './avatar-d7fa8b0c.mjs';
  ...
  ssrRenderList(10, (item) => {
    ...
    _push(ssrRenderComponent(_component_nuxt_link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<div class="card border-0 shadow-sm" style="${ssrRenderStyle({})}"${_scopeId}><div class="card-body"${_scopeId}><div class="row"${_scopeId}><div class="col-2"${_scopeId}><img${ssrRenderAttr("src", _imports_0)} class="rounded img-fluid" alt=""${_scopeId}></div><div class="col-8"${_scopeId}><p class="fw-bold text-primary mt-3 mb-1"${_scopeId}>\u0631\u06A9\u0633\u0627\u0646\u0627 \u0631\u062D\u06CC\u0645\u06CC</p><small class="fw-lighter mt-1 mb-2"${_scopeId}>\u062A\u0648\u0633\u0639\u0647 \u062F\u0647\u0646\u062F\u0647 \u0648\u0628</small><small class="fw-lighter mt-1 mb-2"${_scopeId}>\u0628\u0631\u0627\u06CC \u0627\u06AF\u0647\u06CC \u062A\u0648\u0633\u0639\u0647 \u062F\u0647\u0646\u062F\u0647 \u0648\u0628</small><div class="d-flex justify-content-between"${_scopeId}><small class="fw-lighter mt-1 mb-2"${_scopeId}>\u062A\u0647\u0631\u0627\u0646</small><small class="fw-lighter mt-1 mb-2"${_scopeId}>\u062D\u0642\u0648\u0642 \u062F\u0631\u062E\u0648\u0627\u0633\u062A\u06CC 25.000.000</small><button class="btn btn-sm btn-outline-primary me-2 mb-2"${_scopeId}>\u062A\u0627\u06CC\u06CC\u062F \u0627\u0648\u0644\u06CC\u0647</button></div></div></div></div></div>`);
        } else {
          return [
            createVNode("div", {
...
//# sourceMappingURL=resumes-1727dfc0.mjs.map
