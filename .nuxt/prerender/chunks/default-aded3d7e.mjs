...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-fluid px-0" }, _attrs))}><header><div class="d-flex mx-auto justify-content-between" style="${ssrRenderStyle({ "max-width": "1000px" })}"><div class="d-flex px-md-3">`);
  ...
  _push(`</li></ul></div><div class="d-flex justify-content-end"><ul class="pe-2 py-3"><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
...
//# sourceMappingURL=default-aded3d7e.mjs.map
