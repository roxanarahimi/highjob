  ...
  ssrRenderList(10, (item) => {
    ...
    _push(ssrRenderComponent(_component_nuxt_link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<div class="card border-0 shadow-sm" style="${ssrRenderStyle({})}"${_scopeId}><div class="card-body"${_scopeId}><div class="row"${_scopeId}><div class="col-2"${_scopeId}><img${ssrRenderAttr("src", _imports_0)} class="rounded img-fluid" alt=""${_scopeId}></div><div class="col-10"${_scopeId}><p class="fw-bold text-primary mt-3 mb-1"${_scopeId}>\u0637\u0631\u0627\u062D \u0633\u0627\u06CC\u062A</p><small class="fw-lighter mt-1 mb-2"${_scopeId}>\u06AF\u0631\u0648\u0647 \u062A\u062E\u0635\u0635\u06CC \u0645\u0634\u0627\u0648\u0631\u0627\u0646 \u0648\u0628</small><div class="d-flex justify-content-between"${_scopeId}><small class="fw-lighter mt-1 mb-2"${_scopeId}>\u062A\u0647\u0631\u0627\u0646</small><small class="fw-lighter mt-1 mb-2"${_scopeId}>\u062F\u0648\u0631 \u06A9\u0627\u0631\u06CC</small><small class="fw-lighter mt-1 mb-2"${_scopeId}>\u062D\u0642\u0648\u0642 \u062A\u0648\u0627\u0641\u0642\u06CC</small></div></div></div></div></div>`);
        } else {
          return [
            createVNode("div", {
...
//# sourceMappingURL=requests-888369e0.mjs.map
