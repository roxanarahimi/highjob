...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</li><li><hr class="dropdown-divider"></li><li><a class="dropdown-item" href="#">\u062E\u0631\u0648\u062C</a></li></ul></div></div></div></nav></header><div class="clearfix"></div><div class="mx-auto px-2 px-xl-2" style="${ssrRenderStyle({ "max-width": "1000px" })}">`);
...
//# sourceMappingURL=default-562059a0.mjs.map
